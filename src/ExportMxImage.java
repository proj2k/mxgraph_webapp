...
public class ExportMxImage extends HttpServlet
{
    ...
    protected void handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        int w = mxGraphSmartEditor.getImageWidth();
        int h = mxGraphSmartEditor.getImageHeight();
        String tmp = mxGraphSmartEditor.getImageBgColor();
        String xml = mxGraphSmartEditor.getImageXml();
